...
I should note that this data also includes a lot of other quirks which I don't fully understand, nor will likely ever understand.
...
st.markdown("""
Next, have property valuations really inreased in the county, and if so, by how much? 
...
st.markdown("""
Enter your **PIN** below to see where your property falls within the distribution 
of **Building Value Percent** across the county.
""")
